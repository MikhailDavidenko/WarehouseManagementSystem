...
namespace WarehouseTests
{
    ...
    public class WarehouseManagementTests
    {
        ...
        public void Pallet_Weight_ShouldCalculateCorrectly()
        {
            ...
            // Assert
            Assert.AreEqual(45, pallet.Weight); // 10 + 5 + 30 (áàçîâûé âåñ ïàëëåòû)
        }
        ...
        public void Pallet_CalculateVolume_ShouldCalculateCorrectly()
        {
            ...
            // Assert
            Assert.AreEqual(3084000, pallet.CalculateVolume()); // 200 * 100 * 150 +  (îáúåì êîðîáêè 1) +  (îáúåì êîðîáêè 2)
        }
